...
public partial class _Default : System.Web.UI.Page {
    protected void ASPxPivotGrid1_PopupMenuCreated(object sender,
        DevExpress.Web.ASPxPivotGrid.PivotPopupMenuCreatedEventArgs e) {
    ...
    protected void ASPxPivotGrid1_CustomCallback(object sender,
        DevExpress.Web.ASPxPivotGrid.PivotGridCustomCallbackEventArgs e) {
        ...
        if (parametrs.Length == 4 && parametrs[0] == "MenuItemClick") {
            if (parametrs[1] == "hideValue") {
                ...
                if (field != null)
                    field.FilterValues.Add(pivot.GetFieldValueByIndex(field,
